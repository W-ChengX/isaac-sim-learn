...
- 可选短「中英术语对照」；完整术语见 [docs/glossary.md](docs/glossary.md)。
...
3. 遇到生词查 [术语表](docs/glossary.md)；需要官方入口查 [资源链接](docs/links.md)。
...
- 许可说明见 [LICENSE-NOTES.md](LICENSE-NOTES.md) 与官方 [License FAQ](https://docs.isaacsim.omniverse.nvidia.com/latest/common/license-faq.html)。
